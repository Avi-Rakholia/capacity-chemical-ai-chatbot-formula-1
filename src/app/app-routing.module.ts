...
export const routes: Routes = [
...

  {
    ...
    loadChildren: () =>
      import('./pages/auth-pages/auth-pages.module')
...

  {
    ...
    loadChildren: () =>
      import('./pages/main-pages/main-pages.module')
...

  {
    path: 'setup-guide',
    loadChildren: () =>
      import('./pages/setup-guide/setup-guide.module')
        .then(m => m.SetupGuideModule),
  },
